...
class CheckSettingsWin(QtWidgets.QWidget):
    ...
    def on_pbn_refresh_clicked(self):
        ...
        self.update_profile_settings(self.browser, item.text())
    ...
    def apply_one_profile_settings(
        ...
        append_dic(pref_db, chrome_settings)
        ...
        if browser == "Edge":
            ...
            append_dic(pref_db, edge_settings)
        ...
        # ============= Brave ===================
            ...
            append_dic(pref_db, brave_settings)
